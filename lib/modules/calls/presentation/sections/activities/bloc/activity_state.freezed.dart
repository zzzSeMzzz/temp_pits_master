...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<AlarmModel> activities});
}
...
class __$$SuccessImplCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? activities = null}) {
    return _then(
      _$SuccessImpl(
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required final List<AlarmModel> activities})
    : _activities = activities;

  final List<AlarmModel> _activities;
  @override
  List<AlarmModel> get activities {
...
abstract class _Success implements ActivityState {
  const factory _Success({required final List<AlarmModel> activities}) =
      _$SuccessImpl;
...
class __$$ClearedImplCopyWithImpl<$Res>
    extends _$ActivityStateCopyWithImpl<$Res, _$ClearedImpl>
...
abstract class _Cleared implements ActivityState {
