...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required final List<Vehicle> vehicles})
    : _vehicles = vehicles;
  ...
  @override
  String toString() {
    return 'HomeState.success(vehicles: $vehicles)';
  }
...
abstract class _Success implements HomeState {
  const factory _Success({required final List<Vehicle> vehicles}) =
      _$SuccessImpl;
...
class __$$ClearedImplCopyWithImpl<$Res>
    extends _$HomeStateCopyWithImpl<$Res, _$ClearedImpl>
